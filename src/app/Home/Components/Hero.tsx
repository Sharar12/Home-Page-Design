  ...
  return (
    <section ref={ref} id="hero" className="relative flex min-h-screen w-full items-center overflow-hidden bg-slate-950">
      ...
      <div className="relative z-10 mx-auto w-full max-w-7xl px-6 pt-32 pb-20">
        <div
          className={`max-w-md transition-all duration-[1600ms] ease-luxury ${
            isInView ? "translate-y-0 opacity-100 blur-0" : "translate-y-10 opacity-0 blur-xs"
          }`}
        >

          {/* Small Tag */}
          <p className="mb-4 text-xs font-semibold uppercase tracking-[0.2em] text-lime-400">
            Premium Car Rentals
          </p>
          ...
          {/* Feature Highlights */}
          {/* Feature Highlights */}
          <div className="mt-10 flex flex-col gap-3 text-sm text-slate-200 sm:flex-row sm:flex-wrap sm:gap-4">
            {/* Feature 1 */}
          ...
          <div className="mt-10 flex flex-wrap items-center gap-4">
            ...
            <a
              href="#vehicles"
              className="group shimmer-effect flex items-center gap-2 rounded-full bg-lime-400 px-7 py-3.5 text-sm font-semibold text-black transition-all duration-300 hover:bg-lime-300 hover:scale-105 hover:-translate-y-1 hover:shadow-xl hover:shadow-lime-400/30 active:scale-95 cursor-pointer"
            >
            ...
            <a
              href="#about"
              className="group flex items-center gap-3 rounded-full border border-white/20 bg-white/5 px-5 py-2.5 text-white transition-all duration-300 hover:border-lime-400/60 hover:bg-white/10 hover:scale-105 hover:-translate-y-0.5 hover:shadow-lg hover:shadow-white/10 active:scale-95 cursor-pointer"
            >
          ...
          <div className="mt-12 flex items-center gap-6 border-t border-white/10 pt-6">
            <div>
              ...
              <p className="text-xs text-slate-400">Luxury Fleet</p>
            </div>
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">Happy Drivers</p>
            </div>
            <div className="h-8 w-[1px] bg-white/10" />
            <div>
              <p className="text-2xl font-bold tracking-tight text-white sm:text-3xl">
